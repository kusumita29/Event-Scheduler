...
class Log(Base):
    ...
    event_id = Column(Integer, ForeignKey("events.id", ondelete="CASCADE"), nullable=False)  # Foreign key to Event
    ...
    status = Column(Enum(LogStatus), nullable=False, default=LogStatus.ACTIVE)  # Log status
